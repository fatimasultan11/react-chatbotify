...
import xo, { createContext as Iu, useContext as wu, useState as He, useEffect as Gt, useRef as Zr, isValidElement as Ju, createElement as Ku, forwardRef as Tn } from "react";
var Du = { exports: {} }, Ei = {};
/**
 * @license React
...
function qu() {
  ...
  return Ei.Fragment = S, Ei.jsx = Y, Ei.jsxs = Y, Ei;
}
var Ci = {};
/**
 * @license React
...
function _u() {
  return Eu || (Eu = 1, process.env.NODE_ENV !== "production" && function() {
    var I = xo, h = Symbol.for("react.element"), S = Symbol.for("react.portal"), x = Symbol.for("react.fragment"), f = Symbol.for("react.strict_mode"), R = Symbol.for("react.profiler"), Y = Symbol.for("react.provider"), U = Symbol.for("react.context"), j = Symbol.for("react.forward_ref"), E = Symbol.for("react.suspense"), G = Symbol.for("react.suspense_list"), P = Symbol.for("react.memo"), $ = Symbol.for("react.lazy"), ce = Symbol.for("react.offscreen"), ee = Symbol.iterator, ne = "@@iterator";
    function W(N) {
    ...
    function Me(N, Z, q) {
      {
        ...
        Ee !== "" && (Z += "%s", q = q.concat([Ee]));
        var be = q.map(function(xe) {
          return String(xe);
        });
        be.unshift("Warning: " + Z), Function.prototype.apply.call(console[N], console, be);
      }
    }
    var fe = !1, ue = !1, ye = !1, oe = !1, We = !1, Le;
    Le = Symbol.for("react.module.reference");
    function Ne(N) {
      return !!(typeof N == "string" || typeof N == "function" || N === x || N === R || We || N === f || N === E || N === G || oe || N === ce || fe || ue || ye || typeof N == "object" && N !== null && (N.$$typeof === $ || N.$$typeof === P || N.$$typeof === Y || N.$$typeof === U || N.$$typeof === j || // This needs to include all possible module reference object
    ...
    var pe = Object.assign, Pe = 0, Ke, At, jt, ot, yt, ve, me;
    function It() {
    }
    ...
    function pt() {
      {
        if (Pe === 0) {
          Ke = console.log, At = console.info, jt = console.warn, ot = console.error, yt = console.group, ve = console.groupCollapsed, me = console.groupEnd;
          var N = {
            configurable: !0,
            enumerable: !0,
            value: It,
...
`), ut = le.stack.split(`
`), Re = je.length - 1, Ye = ut.length - 1; Re >= 1 && Ye >= 0 && je[Re] !== ut[Ye]; )
            Ye--;
          for (; Re >= 1 && Ye >= 0; Re--, Ye--)
            if (je[Re] !== ut[Ye]) {
              if (Re !== 1 || Ye !== 1)
                do
                  if (Re--, Ye--, Ye < 0 || je[Re] !== ut[Ye]) {
                    var rt = `
` + je[Re].replace(" at new ", " at ");
        ...
        Mt = !1, Oe.current = be, Ze(), Error.prepareStackTrace = Ee;
      }
    ...
    function Ct(N) {
      if (N) {
        var Z = N._owner, q = Ut(N.type, N._source, Z ? Z.type : null);
        gt.setExtraStackFrame(q);
      } else
        gt.setExtraStackFrame(null);
    }
    function Rt(N, Z, q, le, Ee) {
      {
    ...
    function lr(N, Z) {
      {
        var q = function() {
          ur || (ur = !0, te("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", Z));
        };
    ...
    var cr = function(N, Z, q, le, Ee, be, xe) {
      var je = {
    ...
    function Nr(N, Z, q, le, Ee) {
      {
        var be, xe = {}, je = null, ut = null;
        q !== void 0 && (ar(q), je = "" + q), Kt(Z) && (ar(Z.key), je = "" + Z.key), sr(Z) && (ut = Z.ref, mr(Z, Ee));
        for (be in Z)
          Lt.call(Z, be) && !$e.hasOwnProperty(be) && (xe[be] = Z[be]);
        if (N && N.defaultProps) {
          var Re = N.defaultProps;
          for (be in Re)
            xe[be] === void 0 && (xe[be] = Re[be]);
        }
        if (je || ut) {
          var Ye = typeof N == "function" ? N.displayName || N.name || "Unknown" : N;
          je && lr(xe, Ye), ut && Yt(xe, Ye);
        }
    ...
    function qt(N, Z, q, le, Ee, be) {
      {
        ...
        if (!xe) {
          ...
          ut ? je += ut : je += Ie();
          var Re;
          N === null ? Re = "null" : wt(N) ? Re = "array" : N !== void 0 && N.$$typeof === h ? (Re = "<" + (Ge(N.type) || "Unknown") + " />", je = " Did you accidentally export a JSX literal instead of a component?") : Re = typeof N, te("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", Re, je);
        }
        var Ye = Nr(N, Z, q, Ee, be);
        if (Ye == null)
          return Ye;
        if (xe) {
          var rt = Z.children;
...
const $u = ({
  ...
  const { botOptions: Y, setBotOptions: U } = Zt(), j = {
    background: `linear-gradient(to right, ${(P = Y.theme) == null ? void 0 : P.secondaryColor},
			${($ = Y.theme) == null ? void 0 : $.primaryColor})`,
    ...Y.headerStyle
  }, E = {
    headerAvatar: {
      backgroundImage: `url(${(ce = Y.header) == null ? void 0 : ce.avatar})`
    },
    notificationIcon: {
      backgroundImage: `url(${(ee = Y.notification) == null ? void 0 : ee.icon})`
    },
    audioIcon: {
      backgroundImage: `url(${(ne = Y.audio) == null ? void 0 : ne.icon})`
    },
    closeChatIcon: {
      backgroundImage: `url(${(W = Y.header) == null ? void 0 : W.closeChatIcon})`
    }
  }, G = () => {
    U({ ...Y, isOpen: !1 });
  };
  return /* @__PURE__ */ F.jsxs("div", { style: j, className: "rcb-chat-header-container", children: [
    /* @__PURE__ */ F.jsx(
      "div",
      {
        onMouseDown: (oe) => {
          oe.preventDefault(), console.log("Pressed"), f();
        },
        children: R ? "open" : "opened"
      }
    ),
    /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-header", children: [
      ((b = Y.header) == null ? void 0 : b.showAvatar) && /* @__PURE__ */ F.jsx("div", { style: E.headerAvatar, className: "rcb-bot-avatar" }),
      (te = Y.header) == null ? void 0 : te.title
    ] }),
    /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-header", children: [
      !((Me = Y.notification) != null && Me.disabled) && !((fe = Y.theme) != null && fe.embedded) && /* @__PURE__ */ F.jsx(
        "div",
        {
      ...
      !((ue = Y.audio) != null && ue.disabled) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: E.audioIcon,
          onMouseDown: (oe) => {
      ...
      !((ye = Y.theme) != null && ye.embedded) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: E.closeChatIcon,
          onMouseDown: (oe) => {
            oe.stopPropagation(), G();
          },
...
const es = ({
  ...
  var ce, ee, ne;
  const { botOptions: f } = Zt(), [R, Y] = He(!1), U = {
  ...
  function G(W) {
    ...
    function ye() {
      ...
      I.current.scrollTop = oe, ue < W ? requestAnimationFrame(ye) : S(!1);
    }
    ye();
  }
  ...
  return /* @__PURE__ */ F.jsx("div", { className: `rcb-message-prompt-container ${$()}`, children: /* @__PURE__ */ F.jsx(
    "div",
    {
      onMouseEnter: j,
      onMouseLeave: E,
...
const ts = ({
  ...
  var fe, ue, ye, oe, We, Le, Ne, Qe, ke, Ge;
  const { botOptions: G } = Zt(), { messages: P } = Yu(), $ = {
    ...G == null ? void 0 : G.bodyStyle,
    scrollbarWidth: (fe = G.chatWindow) != null && fe.showScrollbar ? "auto" : "none"
  }, ce = {
    backgroundColor: (ue = G.theme) == null ? void 0 : ue.primaryColor,
    color: "#fff",
    maxWidth: (ye = G.userBubble) != null && ye.showAvatar ? "65%" : "70%",
    ...G.userBubbleStyle
  }, ee = (oe = G.userBubble) != null && oe.animate ? "rcb-user-message-entry" : "", ne = {
    backgroundColor: (We = G.theme) == null ? void 0 : We.secondaryColor,
    color: "#fff",
    maxWidth: (Le = G.botBubble) != null && Le.showAvatar ? "65%" : "70%",
    ...G.botBubbleStyle
  }, W = (Ne = G.botBubble) != null && Ne.animate ? "rcb-bot-message-entry" : "";
  Gt(() => {
    var pe;
    if (I.current) {
      if (S) {
        const { scrollHeight: Pe } = I.current, Ke = Pe - x;
        I.current.scrollTop = I.current.scrollTop + Ke, R(!1);
        return;
      }
      ((pe = G.chatWindow) != null && pe.autoJumpToBottom || !Y) && (I.current.scrollTop = I.current.scrollHeight, G.isOpen && E(0));
    }
  }, [P.length, h]), Gt(() => {
    I.current && (f(I.current.scrollHeight), Y || (I.current.scrollTop = I.current.scrollHeight, G.isOpen && E(0)));
  }, [(Qe = I.current) == null ? void 0 : Qe.scrollHeight]), Gt(() => {
    Y || E(0);
  }, [Y]);
  const b = () => {
    var At;
    ...
    U(
      pe + Pe < Ke - (((At = G.chatWindow) == null ? void 0 : At.messagePromptOffset) || 30)
    ), !Y && pe + Pe >= Ke - 1 && (I.current.scrollTop = Ke - Pe - 1);
  }, te = (pe) => {
    var Pe, Ke, At;
    return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
      (Pe = G == null ? void 0 : G.userBubble) != null && Pe.dangerouslySetInnerHtml ? /* @__PURE__ */ F.jsx(
        "div",
        {
      ...
      ((Ke = G.userBubble) == null ? void 0 : Ke.showAvatar) && /* @__PURE__ */ F.jsx(
        "div",
        {
    ...
    var Pe, Ke, At;
    return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
      ((Pe = G.botBubble) == null ? void 0 : Pe.showAvatar) && /* @__PURE__ */ F.jsx(
        "div",
        {
          style: { backgroundImage: `url(${(Ke = G.botBubble) == null ? void 0 : Ke.avatar})` },
  ...
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      onScroll: b,
      children: [
        P.map((pe, Pe) => typeof pe.content != "string" ? /* @__PURE__ */ F.jsx("div", { children: pe.content }, Pe) : /* @__PURE__ */ F.jsx(
          "div",
          {
...
const rs = ({
  ...
  var E, G, P;
  const { botOptions: h } = Zt(), [S, x] = He(!1), f = {
  ...
  return /* @__PURE__ */ F.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ F.jsx("span", { className: "rcb-send-icon", style: Y })
    }
  );
...
const ns = (I, h, S, x, f) => {
  ...
  const R = (U = I.voice) == null ? void 0 : U.timeoutPeriod, Y = (j = I.voice) == null ? void 0 : j.autoSendPeriod;
  on.onresult = (E) => {
    var P, $;
    clearTimeout(Zn), Zn = null, clearTimeout(hu);
    const G = E.results[E.results.length - 1][0].transcript;
    if (f.current) {
      const ce = (P = I.chatInput) == null ? void 0 : P.characterLimit, ee = f.current.value + G;
      ce != null && ce >= 0 && ee.length > ce ? f.current.value = ee.slice(0, ce) : f.current.value = ee, x(f.current.value.length);
    }
    Zn = setTimeout(() => pu(h), R), ($ = I.voice) != null && $.autoSendDisabled || (hu = setTimeout(S, Y));
  }, on.onend = () => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ F.jsx(
        "span",
        {
          ...
          style: { backgroundImage: `url(${(U = Y.voice) == null ? void 0 : U.icon})` }
        }
      )
    }
  );
...
const as = ({
  ...
  var Ne, Qe, ke, Ge, pe, Pe, Ke, At, jt, ot, yt;
  const { botOptions: U } = Zt(), [j, E] = He(!1), [G, P] = He(0), [$, ce] = He(!1);
  Gt(() => {
    var me;
    const ve = f();
    ve && (Y(ve, (me = I.current) == null ? void 0 : me.value), P(0));
  }, [$]);
  const ee = {
  ...
  }, Me = h ? (ke = U.chatInput) == null ? void 0 : ke.disabledPlaceholderText : (Ge = U.chatInput) == null ? void 0 : Ge.enabledPlaceholderText, fe = () => {
    h || E(!0);
  }, ue = () => {
    E(!1);
  }, ye = (ve) => {
    ...
    if (ve.key === "Enter") {
      if (ve.shiftKey) {
        (me = U.chatInput) != null && me.allowNewline || ve.preventDefault();
        return;
      }
      We(ve);
    }
    ...
    if (I.current) {
      const pt = (me = U.chatInput) == null ? void 0 : me.characterLimit, Oe = ((It = U.chatInput) == null ? void 0 : It.allowNewline) ? ve.target.value : ve.target.value.replace(/\n/g, " ");
    ...
    ve.preventDefault();
    const me = f();
    me && (Y(me, (It = I.current) == null ? void 0 : It.value), P(0));
  }, Le = () => {
    ce((ve) => !ve);
  };
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      children: [
        S && ((pe = U.sensitiveInput) != null && pe.maskInTextArea) ? /* @__PURE__ */ F.jsx(
          "input",
          {
            ref: I,
            type: "password",
        ...
        /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-input-button-container", children: [
          !((Pe = U.voice) != null && Pe.disabled) && Ur && /* @__PURE__ */ F.jsx(
            As,
            {
              inputRef: I,
              textAreaDisabled: h,
          ...
          /* @__PURE__ */ F.jsx(rs, { handleSubmit: We }),
          ((Ke = U.chatInput) == null ? void 0 : Ke.showCharacterCount) && ((At = U.chatInput) == null ? void 0 : At.characterLimit) != null && ((jt = U.chatInput) == null ? void 0 : jt.characterLimit) > 0 && /* @__PURE__ */ F.jsxs(
            "div",
            {
              className: "rcb-chat-input-char-counter",
              style: G >= ((ot = U.chatInput) == null ? void 0 : ot.characterLimit) ? te : b,
              children: [
                G,
                "/",
...
const us = ({
  ...
  var G, P, $, ce;
  const { botOptions: S } = Zt(), x = Zr(null), f = Zr(null), [R, Y] = He(!1), U = {
    cursor: `url(${(G = S.theme) == null ? void 0 : G.actionDisabledIcon}), auto`
  };
  Gt(() => {
    const ee = (b) => {
      x.current && !x.current.contains(b.target) && f.current && !f.current.contains(b.target) && Y(!1);
    }, ne = () => {
  ...
  return /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
    ...
    R && /* @__PURE__ */ F.jsx("div", { className: "rcb-emoji-picker-popup", ref: x, children: (ce = ($ = S.emoji) == null ? void 0 : $.list) == null ? void 0 : ce.map((ee, ne) => /* @__PURE__ */ F.jsx(
      "span",
      {
        className: "rcb-emoji",
...
const ss = ({
  ...
  var ee, ne, W, b, te;
  const { botOptions: E } = Zt(), { paths: G } = Na(), [P, $] = He(!1);
  Gt(() => {
    const Me = R();
    if (!Me)
      return;
...
const ls = ({
  ...
  return /* @__PURE__ */ F.jsxs("div", { style: G.footerStyle, className: "rcb-chat-footer-container", children: [
    /* @__PURE__ */ F.jsxs("div", { className: "rcb-chat-footer", children: [
      ...
      !(($ = G.emoji) != null && $.disabled) && /* @__PURE__ */ F.jsx(us, { inputRef: I, textAreaDisabled: S })
    ] }),
    /* @__PURE__ */ F.jsx("span", { children: (ce = G.footer) == null ? void 0 : ce.text })
  ] });
};
const cs = ({
  unreadCount: I
  ...
  var R, Y, U, j;
  const { botOptions: h, setBotOptions: S } = Zt(), x = () => {
    S({ ...h, isOpen: !h.isOpen });
  }, f = {
  ...
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: !((Y = h.theme) != null && Y.embedded) && /* @__PURE__ */ F.jsx(
    "button",
    {
      ...
      onClick: x,
      children: !((U = h.notification) != null && U.disabled) && ((j = h.notification) == null ? void 0 : j.showCount) && /* @__PURE__ */ F.jsx("span", { style: h.notificationBadgeStyle, className: "rcb-badge", children: I })
    }
  ) });
};
const fs = () => {
  var G, P, $, ce, ee;
  const { botOptions: I, setBotOptions: h } = Zt(), [S, x] = He(!1), [f, R] = He(!1), [Y, U] = He(0);
  Gt(() => {
    var W, b, te;
    ...
    if (ne === "ALWAYS")
      ...
      ne === "NEVER" ? x(!1) : ne === "START" ? f ? x(!1) : (R(!0), x(!0)) : ne === "CLOSE" && x(!I.isOpen);
  }, [I.isOpen]);
  const j = {
  ...
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: !((ce = I.theme) != null && ce.embedded) && /* @__PURE__ */ F.jsxs(
    "div",
    {
      style: j,
...
const ds = ({
  ...
  var j, E, G;
  const { botOptions: S } = Zt(), [x, f] = He(!1), R = {
...
const Ms = ({
  ...
  const { botOptions: f } = Zt(), { paths: R } = Na(), [Y, U] = He(/* @__PURE__ */ new Set()), [j, E] = He(!1), G = {
    ...
    cursor: j || Y.size < I.min ? `url(${(te = f.theme) == null ? void 0 : te.actionDisabledIcon}), auto` : "pointer",
  ...
  return /* @__PURE__ */ F.jsxs("div", { className: `rcb-checkbox-container ${(Le = f.botBubble) != null && Le.showAvatar ? "rcb-checkbox-offset" : ""}`, children: [
    I.items.map((Ne) => /* @__PURE__ */ F.jsx(
      "div",
      {
        onMouseDown: (Qe) => {
        ...
        children: /* @__PURE__ */ F.jsxs("div", { className: "rcb-checkbox-row", children: [
          ...
          /* @__PURE__ */ F.jsx("div", { className: "rcb-checkbox-label", children: Ne })
        ] })
      },
      Ne
    )),
    /* @__PURE__ */ F.jsx(
      "button",
      {
        ...
        disabled: j || Y.size < I.min,
        onMouseDown: (Ne) => {
          var ke;
          Ne.preventDefault();
          const Qe = Array.from(h).join(", ");
          E(!0), x(S, Qe, (ke = f.chatInput) == null ? void 0 : ke.sendCheckboxOutput);
        }
      }
    )
  ] });
...
const ps = ({
  ...
  var ce, ee, ne, W, b, te;
  const { botOptions: x } = Zt(), { paths: f } = Na(), [R, Y] = He([]), [U, j] = He(!1), E = {
  ...
  return /* @__PURE__ */ F.jsx("div", { className: `rcb-options-container ${(te = x.botBubble) != null && te.showAvatar ? "rcb-options-offset" : ""}`, children: I.map((Me, fe) => {
    const ue = R[fe] && !U;
    return /* @__PURE__ */ F.jsx(
      "div",
      {
        ...
        onMouseDown: (ye) => {
          var oe;
          ye.preventDefault(), !U && (j(!0), S(h, Me, (oe = x.chatInput) == null ? void 0 : oe.sendOptionOutput));
        },
        children: Me
      },
      Me
  ...
  const Y = R.transition;
  let U;
  if (typeof Y == "function" ? (U = Y(S), U instanceof Promise && (U = await U)) : U = Y, !U || U instanceof Promise || U.duration == null || typeof U.duration != "number")
    return;
      ...
      if (S.call(g, p)) {
        ...
        if (z != null && typeof z != "boolean" && z !== "") {
          if (p.indexOf("--") === 0) {
            ...
            m = p;
            var B = fe.get(m);
            B !== void 0 || (B = ee(m.replace(ne, "-$1").toLowerCase().replace(W, "-ms-")), fe.set(m, B)), m = B, z = typeof z == "number" ? z === 0 || S.call(P, p) ? "" + z : z + "px" : ee(("" + z).trim());
          }
...
`), m;
          ...
          if (S.call(g, ge) && (X = g[ge], X != null))
            switch (ge) {
              ...
              case "suppressHydrationWarning":
                break;
              default:
                Y(ge) && typeof X != "function" && typeof X != "symbol" && A.push(" ", ge, '="', ee(X), '"');
            }
        return A.push(">"), oe(A, B, m), m;
    }
  }
  ...
  var ve = Object.assign, me = Symbol.for("react.element"), It = Symbol.for("react.portal"), pt = Symbol.for("react.fragment"), Ze = Symbol.for("react.strict_mode"), Oe = Symbol.for("react.profiler"), Bt = Symbol.for("react.provider"), Et = Symbol.for("react.context"), Mt = Symbol.for("react.forward_ref"), St = Symbol.for("react.suspense"), vt = Symbol.for("react.suspense_list"), Dt = Symbol.for("react.memo"), _e = Symbol.for("react.lazy"), it = Symbol.for("react.scope"), Ut = Symbol.for("react.debug_trace_mode"), Lt = Symbol.for("react.legacy_hidden"), Xt = Symbol.for("react.default_value"), gt = Symbol.iterator;
  function Ct(A) {
    if (A == null)
      return null;
      ...
      if (s = A.state, typeof A.componentWillMount == "function" && A.componentWillMount(), typeof A.UNSAFE_componentWillMount == "function" && A.UNSAFE_componentWillMount(), s !== A.state && ur.enqueueReplaceState(A, A.state, null), m.queue !== null && 0 < m.queue.length)
        if (s = m.queue, B = m.replace, m.queue = null, m.replace = !1, B && s.length === 1)
          ...
          for (m = B ? s[0] : A.state, z = !0, B = B ? 1 : 0; B < s.length; B++) {
            var X = s[B];
            X = typeof X == "function" ? X.call(A, m, g, p) : X, X != null && (z ? (z = !1, m = ve({}, m, X)) : ve(m, X));
          }
          A.state = m;
        }
      else
  ...
  var Kt = Math.clz32 ? Math.clz32 : Yt, mr = Math.log, lr = Math.LN2;
  function Yt(A) {
  ...
  var Nr = typeof Object.is == "function" ? Object.is : cr, ft = null, K = null, Ae = null, _ = null, de = !1, Ie = !1, Se = 0, we = null, Fe = 0;
  function Xe() {
    if (ft === null)
      throw Error(h(321));
    return ft;
  ...
  function Nt() {
    K = ft = null, Ie = !1, Ae = null, Fe = 0, _ = we = null;
  }
  function qt(A, s) {
  ...
  var Z = { readContext: function(A) {
  ...
  }, useMemo: Rr, useReducer: at, useRef: function(A) {
    ft = Xe(), _ = mt();
    ...
    if (g === null)
      throw Error(h(404));
    return s = Se++, A = ":" + g.idPrefix + "R" + A, 0 < s && (A += "H" + s.toString(32)), A + ":";
  ...
  function xe(A, s, g, p, z, m, B, X, ie) {
    ...
    return s = { destination: null, responseState: s, progressiveChunkSize: p === void 0 ? 12800 : p, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: se, pingedTasks: ge, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: z === void 0 ? Ee : z, onAllReady: m === void 0 ? be : m, onShellReady: B === void 0 ? be : B, onShellError: X === void 0 ? be : X, onFatalError: ie === void 0 ? be : ie }, g = ut(s, 0, null, g, !1, !1), g.parentFlushed = !0, A = je(s, A, null, g, se, Rt, null, Jt), ge.push(A), s;
  }
  ...
  function rt(A, s, g, p, z) {
    for (ft = {}, K = s, Se = 0, A = g(p, z); Ie; )
      Ie = !1, Se = 0, Fe += 1, _ = null, A = g(p, z);
    return Nt(), A;
  }
  function Qt(A, s, g, p) {
  ...
  function st(A, s, g, p, z) {
    if (typeof g == "function")
      if (g.prototype && g.prototype.isReactComponent) {
        ...
        m = Sr(g, s.legacyContext), z = rt(A, s, g, p, m);
        var B = Se !== 0;
      ...
      switch (z = s.blockedSegment, m = Ge(z.chunks, g, p, A.responseState, z.formatContext), z.lastPushedText = !1, B = z.formatContext, z.formatContext = Me(B, g, p), _t(A, s, m), z.formatContext = B, g) {
        case "area":
        case "base":
        case "br":
        case "col":
          ...
          if (ie.status === 0) {
            ...
            try {
              ...
              if (Nt(), typeof kt == "object" && kt !== null && typeof kt.then == "function") {
                ...
                var se = B.blockedBoundary, Be = kt, Ht = Re(X, Be);
                if (se === null ? Ye(X, Be) : (se.pendingTasks--, se.forceClientRender || (se.forceClientRender = !0, se.errorDigest = Ht, se.parentFlushed && X.clientRenderedBoundaries.push(se))), X.allPendingTasks--, X.allPendingTasks === 0) {
                  var zt = X.onAllReady;
                  zt();
                }
              }
...
function ws() {
  ...
  function W(o, l, M, v, k, C, H) {
    this.acceptsBooleans = l === 2 || l === 3 || l === 4, this.attributeName = v, this.attributeNamespace = k, this.mustUseProperty = M, this.propertyName = o, this.type = l, this.sanitizeURL = C, this.removeEmptyString = H;
  }
  var b = {};
  ...
  var We = /([A-Z])/g, Le = /^ms-/, Ne = Array.isArray, Qe = E("<script>"), ke = E("<\/script>"), Ge = E('<script src="'), pe = E('<script type="module" src="'), Pe = E('" async=""><\/script>'), Ke = /(<\/|<)(s)(cript)/gi;
  function At(o, l, M, v) {
    return "" + l + (M === "s" ? "\\u0073" : "\\u0053") + v;
  }
  function jt(o, l, M, v, k) {
    ...
    var C = [];
    if (M !== void 0 && C.push(l, j(("" + M).replace(Ke, At)), ke), v !== void 0)
      for (M = 0; M < v.length; M++)
        C.push(Ge, j(oe(v[M])), Pe);
    if (k !== void 0)
      for (v = 0; v < k.length; v++)
        C.push(pe, j(oe(k[v])), Pe);
  ...
  var me = E("<!-- -->");
  function It(o, l, M, v) {
    return l === "" ? v : (v && o.push(me), o.push(j(oe(l))), !0);
  }
  var pt = /* @__PURE__ */ new Map(), Ze = E(' style="'), Oe = E(":"), Bt = E(";");
  function Et(o, l, M) {
    if (typeof M != "object")
      throw Error(h(62));
    l = !0;
      ...
      if (P.call(M, v)) {
        ...
        if (k != null && typeof k != "boolean" && k !== "") {
          if (v.indexOf("--") === 0) {
            ...
            C = v;
            var H = pt.get(C);
            H !== void 0 || (H = E(oe(C.replace(We, "-$1").toLowerCase().replace(Le, "-ms-"))), pt.set(C, H)), C = H, k = typeof k == "number" ? k === 0 || P.call(fe, v) ? j("" + k) : j(k + "px") : j(oe(("" + k).trim()));
          }
          l ? (l = !1, o.push(Ze, C, Oe, k)) : o.push(Bt, C, Oe, k);
        }
      }
    l || o.push(vt);
  }
  var Mt = E(" "), St = E('="'), vt = E('"'), Dt = E('=""');
  function _e(o, l, M, v) {
    switch (M) {
      case "style":
        Et(o, l, v);
      ...
      if (l = b.hasOwnProperty(M) ? b[M] : null, l !== null) {
        ...
        switch (M = j(l.attributeName), l.type) {
          case 3:
            ...
            break;
          case 4:
            v === !0 ? o.push(Mt, M, Dt) : v !== !1 && o.push(Mt, M, St, j(oe(v)), vt);
            break;
          case 5:
            isNaN(v) || o.push(Mt, M, St, j(oe(v)), vt);
            break;
          case 6:
            !isNaN(v) && 1 <= v && o.push(Mt, M, St, j(oe(v)), vt);
            break;
          default:
            l.sanitizeURL && (v = "" + v), o.push(Mt, M, St, j(oe(v)), vt);
        }
      } else if (ne(M)) {
        switch (typeof v) {
          case "function":
  ...
  function ir(o, l, M, v, k) {
    switch (l) {
      case "select":
        ...
        return o.push(it), Lt(o, H, C), C;
      case "option":
        H = k.selectedValue, o.push(ht("option"));
        var he = J = null, Ce = null, Te = null;
        for (C in M)
          if (P.call(M, C)) {
            var qe = M[C];
            if (qe != null)
        ...
        if (H != null)
          ...
          Ce && o.push(gt);
        return o.push(it), Lt(o, Te, J), J;
      case "textarea":
        o.push(ht("textarea")), Te = H = C = null;
        for (J in M)
        ...
        if (C === null && H !== null && (C = H), o.push(it), Te != null) {
          if (C != null)
            throw Error(h(92));
          if (Ne(Te) && 1 < Te.length)
            throw Error(h(93));
          C = "" + Te;
        }
        return typeof C == "string" && C[0] === `
` && o.push(Rt), C !== null && o.push(j(oe("" + C))), null;
      case "input":
        o.push(ht("input")), he = Te = J = C = null;
        for (H in M)
          if (P.call(M, H) && (Ce = M[H], Ce != null))
            switch (H) {
              case "children":
              case "dangerouslySetInnerHTML":
                throw Error(h(399, "input"));
        ...
        return Te !== null ? _e(
          ...
          "checked",
          Te
        ) : he !== null && _e(o, v, "checked", he), C !== null ? _e(o, v, "value", C) : J !== null && _e(o, v, "value", J), o.push(Ut), null;
      case "menuitem":
        o.push(ht("menuitem"));
        for (var Vt in M)
...
` && o.push(Rt), C;
      ...
      case "missing-glyph":
        return Ct(o, M, l, v);
      case "html":
        return k.insertionMode === 0 && o.push(tt), Ct(o, M, l, v);
      default:
          ...
          if (P.call(M, Ce) && (J = M[Ce], J != null))
            switch (Ce) {
              ...
              case "suppressHydrationWarning":
                break;
              default:
                ne(Ce) && typeof J != "function" && typeof J != "symbol" && o.push(Mt, j(Ce), St, j(oe(J)), vt);
            }
        return o.push(it), Lt(o, H, C), C;
    }
  }
  var ar = E("</"), xt = E(">"), $e = E('<template id="'), ur = E('"></template>'), Lr = E("<!--$-->"), Jt = E('<!--$?--><template id="'), sr = E('"></template>'), Kt = E("<!--$!-->"), mr = E("<!--/$-->"), lr = E("<template"), Yt = E('"'), cr = E(' data-dgst="');
  ...
  var K = E('<div hidden id="'), Ae = E('">'), _ = E("</div>"), de = E('<svg aria-hidden="true" style="display:none" id="'), Ie = E('">'), Se = E("</svg>"), we = E('<math aria-hidden="true" style="display:none" id="'), Fe = E('">'), Xe = E("</math>"), ze = E('<table hidden id="'), mt = E('">'), Nt = E("</table>"), qt = E('<table hidden><tbody id="'), at = E('">'), Rr = E("</tbody></table>"), an = E('<table hidden><tr id="'), un = E('">'), N = E("</tr></table>"), Z = E('<table hidden><colgroup id="'), q = E('">'), le = E("</colgroup></table>");
  function Ee(o, l, M, v) {
    switch (M.insertionMode) {
      case 0:
      case 1:
        return f(o, K), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, Ae);
      case 2:
        return f(o, de), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, Ie);
      case 3:
        return f(o, we), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, Fe);
      case 4:
        return f(o, ze), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, mt);
      case 5:
        return f(o, qt), f(o, l.segmentPrefix), f(o, j(v.toString(16))), R(o, at);
      case 6:
  ...
  function $t(o) {
    var l = se;
    l !== o && (l === null ? zt(o) : o === null ? Ht(l) : l.depth === o.depth ? Be(l, o) : l.depth > o.depth ? kt(l, o) : Ir(l, o), se = o);
  }
  ...
  function xr(o, l, M, v) {
    ...
    o._reactInternals = C;
    var H = l.contextType;
    if (o.context = typeof H == "object" && H !== null ? H._currentValue : v, H = l.getDerivedStateFromProps, typeof H == "function" && (H = H(M, k), k = H == null ? k : gr({}, k, H), o.state = k), typeof l.getDerivedStateFromProps != "function" && typeof o.getSnapshotBeforeUpdate != "function" && (typeof o.UNSAFE_componentWillMount == "function" || typeof o.componentWillMount == "function"))
      if (l = o.state, typeof o.componentWillMount == "function" && o.componentWillMount(), typeof o.UNSAFE_componentWillMount == "function" && o.UNSAFE_componentWillMount(), l !== o.state && _r.enqueueReplaceState(o, o.state, null), C.queue !== null && 0 < C.queue.length)
        if (l = C.queue, H = C.replace, C.queue = null, C.replace = !1, H && l.length === 1)
          o.state = l[0];
        else {
          for (C = H ? l[0] : o.state, k = !0, H = H ? 1 : 0; H < l.length; H++) {
            var J = l[H];
  ...
  function wr(o, l, M) {
    ...
    if (30 < C) {
      var H = k - k % 5;
      return C = (v & (1 << H) - 1).toString(32), v >>= H, k -= H, { id: 1 << 32 - fn(l) + k | M << k | v, overflow: C + o };
    }
  ...
  var Jn = typeof Object.is == "function" ? Object.is : bo, Tr = null, dn = null, Sn = null, Je = null, zr = !1, Ft = !1, Hr = 0, kr = null, mn = 0;
  function br() {
    if (Tr === null)
      throw Error(h(321));
    return Tr;
  ...
  function Kn() {
    return Je === null ? Sn === null ? (zr = !1, Sn = Je = er()) : (zr = !0, Je = Sn) : Je.next === null ? (zr = !1, Je = Je.next = er()) : (zr = !0, Je = Je.next), Je;
  }
  function qn() {
    dn = Tr = null, Ft = !1, Sn = null, mn = 0, Je = kr = null;
  }
  function zA(o, l) {
  ...
  function kA(o, l, M) {
    if (Tr = br(), Je = Kn(), zr) {
      var v = Je.queue;
      if (l = v.dispatch, kr !== null && (M = kr.get(v), M !== void 0)) {
        kr.delete(v), v = Je.memoizedState;
        do
          v = o(v, M.action), M = M.next;
        while (M !== null);
        return Je.memoizedState = v, [v, l];
      }
      return [Je.memoizedState, l];
    }
    return o = o === zA ? typeof l == "function" ? l() : l : M !== void 0 ? M(l) : l, Je.memoizedState = o, o = Je.queue = { last: null, dispatch: null }, o = o.dispatch = Oo.bind(null, Tr, o), [Je.memoizedState, o];
  }
  function bA(o, l) {
    if (Tr = br(), Je = Kn(), l = l === void 0 ? null : l, Je !== null) {
  ...
  function Oo(o, l, M) {
    if (25 <= mn)
      throw Error(h(301));
    if (o === Tr)
      if (Ft = !0, o = { action: M, next: null }, kr === null && (kr = /* @__PURE__ */ new Map()), M = kr.get(l), M === void 0)
        kr.set(l, o);
      else {
        for (l = M; l.next !== null; )
          l = l.next;
  ...
  function _n(o, l, M, v, k, C, H, J, he) {
    var Ce = [], Te = /* @__PURE__ */ new Set();
    return l = { destination: null, responseState: l, progressiveChunkSize: v === void 0 ? 12800 : v, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: Te, pingedTasks: Ce, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: k === void 0 ? Po : k, onAllReady: C === void 0 ? gn : C, onShellReady: H === void 0 ? gn : H, onShellError: J === void 0 ? gn : J, onFatalError: he === void 0 ? gn : he }, M = $r(l, 0, null, M, !1, !1), M.parentFlushed = !0, o = $n(l, o, null, M, Te, ie, null, Yr), Ce.push(o), l;
  }
  function $n(o, l, M, v, k, C, H, J) {
    o.allPendingTasks++, M === null ? o.pendingRootTasks++ : M.pendingTasks++;
    var he = { node: l, ping: function() {
      var Ce = o.pingedTasks;
      Ce.push(he), Ce.length === 1 && RA(o);
    }, blockedBoundary: M, blockedSegment: v, abortSet: k, legacyContext: C, context: H, treeContext: J };
    return k.add(he), he;
  }
  ...
  function OA(o, l, M, v, k) {
    for (Tr = {}, dn = l, Hr = 0, o = M(v, k); Ft; )
      Ft = !1, Hr = 0, mn += 1, Je = null, o = M(v, k);
    return qn(), o;
  }
  function eA(o, l, M, v) {
    var k = M.render(), C = v.childContextTypes;
    if (C != null) {
      var H = l.legacyContext;
      ...
      l.legacyContext = v, Wt(o, l, k), l.legacyContext = H;
    } else
      Wt(o, l, k);
  }
  function QA(o, l) {
  ...
  function kn(o, l, M, v, k) {
    if (typeof M == "function")
      if (M.prototype && M.prototype.isReactComponent) {
        ...
        var C = M.contextType;
        C = new M(v, typeof C == "object" && C !== null ? C._currentValue : k), xr(C, M, v, k), eA(o, l, C, M);
      } else {
        C = ge(M, l.legacyContext), k = OA(o, l, M, v, C);
        var H = Hr !== 0;
        if (typeof k == "object" && k !== null && typeof k.render == "function" && k.$$typeof === void 0)
          xr(k, M, v, C), eA(o, l, k, M);
        else if (H) {
          v = l.treeContext, l.treeContext = wr(v, 1, 0);
          try {
            Wt(o, l, k);
          } finally {
            l.treeContext = v;
      ...
      switch (k = l.blockedSegment, C = ir(k.chunks, M, v, o.responseState, k.formatContext), k.lastPushedText = !1, H = k.formatContext, k.formatContext = ve(H, M, v), bn(o, l, C), k.formatContext = H, M) {
        case "area":
        case "base":
        case "br":
        case "col":
      ...
      switch (M) {
        ...
        case Kr:
          e: {
            M = l.blockedBoundary, k = l.blockedSegment, C = v.fallback, v = v.children, H = /* @__PURE__ */ new Set();
            var J = { id: null, rootSegmentID: -1, parentFlushed: !1, pendingTasks: 0, forceClientRender: !1, completedSegments: [], byteSize: 0, fallbackAbortableTasks: H, errorDigest: null }, he = $r(o, k.chunks.length, J, k.formatContext, !1, !1);
            ...
            try {
              ...
              Ce.status = 4, J.forceClientRender = !0, J.errorDigest = en(o, Te);
            } finally {
              l.blockedBoundary = M, l.blockedSegment = k;
            }
            l = $n(o, C, M, he, H, l.legacyContext, l.context, l.treeContext), o.pingedTasks.push(l);
          }
          return;
      }
      if (typeof M == "object" && M !== null)
        switch (M.$$typeof) {
          ...
          case A:
            ...
            return;
          case Jr:
            if (k = v.children, M = M._context, v = v.value, C = M._currentValue, M._currentValue = v, H = se, se = v = { parent: H, depth: H === null ? 0 : H.depth + 1, context: M, parentValue: C, value: v }, l.context = v, Wt(o, l, k), o = se, o === null)
              throw Error(h(403));
  ...
  function Wt(o, l, M) {
    ...
    typeof M == "string" ? (v = l.blockedSegment, v.lastPushedText = It(l.blockedSegment.chunks, M, o.responseState, v.lastPushedText)) : typeof M == "number" && (v = l.blockedSegment, v.lastPushedText = It(l.blockedSegment.chunks, "" + M, o.responseState, v.lastPushedText));
  }
  function PA(o, l, M) {
    for (var v = M.length, k = 0; k < v; k++) {
      var C = l.treeContext;
      l.treeContext = wr(C, v, k);
      try {
        bn(o, l, M[k]);
      } finally {
        l.treeContext = C;
  ...
  function bn(o, l, M) {
    ...
    try {
      ...
      if (qn(), typeof he == "object" && he !== null && typeof he.then == "function") {
        M = he;
        var H = l.blockedSegment, J = $r(o, H.chunks.length, null, H.formatContext, H.lastPushedText, !0);
        H.children.push(J), H.lastPushedText = !1, o = $n(o, l.node, l.blockedBoundary, J, l.abortSet, l.legacyContext, l.context, l.treeContext).ping, M.then(o, o), l.blockedSegment.formatContext = v, l.legacyContext = k, l.context = C, $t(C);
      } else
        throw l.blockedSegment.formatContext = v, l.legacyContext = k, l.context = C, $t(C), he;
    }
  }
  function Bo(o) {
    ...
    if (o.status !== 2) {
      ...
      try {
        ...
        for (C = 0; C < k.length; C++) {
          var H = k[C], J = o, he = H.blockedSegment;
          if (he.status === 0) {
            $t(H.context);
            try {
              Wt(J, H, H.node), he.lastPushedText && he.textEmbedded && he.chunks.push(me), H.abortSet.delete(H), he.status = 1, UA(J, H.blockedBoundary, he);
            } catch (rr) {
              if (qn(), typeof rr == "object" && rr !== null && typeof rr.then == "function") {
                ...
                var Te = H.blockedBoundary, qe = rr, Vt = en(J, qe);
                if (Te === null ? zn(J, qe) : (Te.pendingTasks--, Te.forceClientRender || (Te.forceClientRender = !0, Te.errorDigest = Vt, Te.parentFlushed && J.clientRenderedBoundaries.push(Te))), J.allPendingTasks--, J.allPendingTasks === 0) {
                  var tr = J.onAllReady;
                  tr();
                }
              }
  ...
  function Qn(o, l, M) {
    switch (M.parentFlushed = !0, M.status) {
      case 0:
        ...
        return M.lastPushedText = !1, M.textEmbedded = !1, o = o.responseState, f(l, $e), f(l, o.placeholderPrefix), o = j(v.toString(16)), f(l, o), R(l, ur);
      case 1:
        M.status = 2;
        var k = !0;
        v = M.chunks;
  ...
  function Pn(o, l, M) {
    ...
    if (v.parentFlushed = !0, v.forceClientRender)
      v = v.errorDigest, R(l, Kt), f(l, lr), v && (f(l, cr), f(l, j(oe(v))), f(l, Yt)), R(l, Nr), Qn(o, l, M);
      ...
      k = E(k.boundaryPrefix + C.toString(16)), v = v.id = k, ft(l, o.responseState, v), Qn(o, l, M);
    } else if (v.byteSize > o.progressiveChunkSize)
      v.rootSegmentID = o.nextSegmentId++, o.completedBoundaries.push(v), ft(l, o.responseState, v.id), Qn(o, l, M);
    else {
      if (R(l, Lr), M = v.completedSegments, M.length !== 1)
        throw Error(h(391));
      Pn(o, l, M[0]);
    }
    return R(l, mr);
  ...
  function HA(o, l, M) {
    for (var v = M.completedSegments, k = 0; k < v.length; k++)
      FA(o, l, M, v[k]);
    if (v.length = 0, o = o.responseState, v = M.id, M = M.rootSegmentID, f(l, o.startInlineScript), o.sentCompleteBoundaryFunction ? f(l, rt) : (o.sentCompleteBoundaryFunction = !0, f(l, Ye)), v === null)
      throw Error(h(395));
    return M = j(M.toString(16)), f(l, v), f(l, Qt), f(l, o.segmentPrefix), f(l, M), R(l, fr);
  }
  function FA(o, l, M, v) {
    if (v.status === 2)
      return !0;
    ...
    return YA(o, l, v), o = o.responseState, f(l, o.startInlineScript), o.sentCompleteSegmentFunction ? f(l, je) : (o.sentCompleteSegmentFunction = !0, f(l, xe)), f(l, o.segmentPrefix), k = j(k.toString(16)), f(l, k), f(l, ut), f(l, o.placeholderPrefix), f(l, k), R(l, Re);
  }
  function tA(o, l) {
    ...
    try {
      ...
      for (C = 0; C < k.length; C++) {
        var H = k[C];
        v = l;
        var J = o.responseState, he = H.id, Ce = H.errorDigest, Te = H.errorMessage, qe = H.errorComponentStack;
        if (f(v, J.startInlineScript), J.sentClientRenderFunction ? f(v, lt) : (J.sentClientRenderFunction = !0, f(
          v,
          st
        )), he === null)
          throw Error(h(395));
        f(v, he), f(v, dr), (Ce || Te || qe) && (f(v, Tt), f(v, j(Mr(Ce || "")))), (Te || qe) && (f(v, Tt), f(v, j(Mr(Te || "")))), qe && (f(v, Tt), f(v, j(Mr(qe)))), R(v, _t);
      }
      k.splice(0, C);
      var Vt = o.completedBoundaries;
      for (C = 0; C < Vt.length; C++)
        HA(o, l, Vt[C]);
      Vt.splice(0, C), Y(l), S = new Uint8Array(512), x = 0;
      ...
      Y(l), o.allPendingTasks === 0 && o.pingedTasks.length === 0 && o.clientRenderedBoundaries.length === 0 && o.completedBoundaries.length === 0 && l.close();
    }
  }
  function WA(o, l) {
    try {
  ...
  return va.renderToReadableStream = function(o, l) {
    return new Promise(function(M, v) {
      var k, C, H = new Promise(function(Te, qe) {
        C = Te, k = qe;
        ...
        var Te = new ReadableStream({ type: "bytes", pull: function(qe) {
          if (J.status === 1)
            J.status = 2, G(qe, J.fatalError);
...
function Ts() {
  return bu || (bu = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var ue = Object.prototype.hasOwnProperty, ye = 0, oe = 1, We = 2, Le = 3, Ne = 4, Qe = 5, ke = 6, Ge = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", pe = Ge + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", Pe = new RegExp("^[" + Ge + "][" + pe + "]*$"), Ke = {}, At = {};
    function jt(e) {
    ...
    function ve(e, r, i, u, d, D, w) {
      this.acceptsBooleans = r === We || r === Le || r === Ne, this.attributeName = u, this.attributeNamespace = d, this.mustUseProperty = i, this.propertyName = e, this.type = r, this.sanitizeURL = D, this.removeEmptyString = w;
    }
    var me = {}, It = [
      "children",
    ...
    function Xt(e, r) {
      {
        ...
        if (Ut.test(r)) {
          var d = r.toLowerCase(), D = _e.hasOwnProperty(d) ? d : null;
          if (D == null)
            return it[r] = !0, !1;
          if (r !== D)
            return f("Unknown ARIA attribute `%s`. Did you mean `%s`?", r, D), it[r] = !0, !0;
        }
      }
      return !0;
    }
    ...
    {
      var sr = /^(?:webkit|moz|o)[A-Z]/, Kt = /^-ms-/, mr = /-(.)/g, lr = /;\s*$/, Yt = {}, cr = {}, Nr = !1, ft = !1, K = function(e) {
      ...
      Jt = function(e, r) {
        e.indexOf("-") > -1 ? Ae(e) : sr.test(e) ? _(e) : lr.test(r) && de(e, r), typeof r == "number" && (isNaN(r) ? Ie(e, r) : isFinite(r) || Se(e, r));
      };
    }
    var we = Jt, Fe = /["'&<>]/;
    function Xe(e) {
    ...
    var at = /^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i, Rr = !1;
    function an(e) {
      !Rr && at.test(e) && (Rr = !0, f("A future version of React will block javascript: URLs as a security precaution. Use event handlers instead if you can. If you need to generate unsafe HTML try using dangerouslySetInnerHTML instead. React was passed %s.", JSON.stringify(e)));
    }
    var un = Array.isArray;
    function N(e) {
      return un(e);
    }
    var Z = "<script>", q = "<\/script>", le = '<script src="', Ee = '<script type="module" src="', be = '" async=""><\/script>';
    function xe(e) {
    ...
    var Ye = 0, rt = 1, Qt = 2, fr = 3, st = 4, lt = 5, dr = 6, _t = 7;
    function Tt(e, r) {
      return {
        insertionMode: e,
        selectedValue: r
    ...
    function Xr(e, r, i) {
      ...
      return e.insertionMode >= st || e.insertionMode === Ye ? Tt(rt, null) : e;
    }
    var Mr = null;
    function gr(e) {
      ...
      for (var d in i)
        if (ue.call(i, d)) {
          ...
          if (!(D == null || typeof D == "boolean" || D === "")) {
            ...
            V ? (w = ze(d), Me(D, d), O = ze(("" + D).trim())) : (we(d, D), w = Cr(d), typeof D == "number" ? D !== 0 && !ue.call(Bt, d) ? O = D + "px" : O = "" + D : (Me(D, d), O = ze(("" + D).trim()))), u ? (u = !1, e.push(cn, w, Kr, O)) : e.push(qr, w, Kr, O);
          }
        }
      u || e.push(p);
    }
        ...
        if (d !== null) {
          ...
          switch (d.type) {
            ...
            case ke:
              ...
              break;
            default:
              d.sanitizeURL && (te(u, D), u = "" + u, an(u)), e.push(s, w, g, ze(u), p);
          }
        } else if (jt(i)) {
          switch (typeof u) {
            case "function":
    ...
    var ge = !1, se = !1, Be = !1, Ht = !1, zt = !1, kt = !1, Ir = !1;
    function $t(e, r) {
      {
        var i = e[r];
        if (i != null) {
    ...
    function _r(e, r, i) {
      vt("select", r), $t(r, "value"), $t(r, "defaultValue"), r.value !== void 0 && r.defaultValue !== void 0 && !Be && (f("Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Be = !0), e.push(Ft("select"));
      var u = null, d = null;
      for (var D in r)
        if (ue.call(r, D)) {
          var w = r[D];
    ...
    function wr(e, r, i, u) {
      ...
      if (d != null) {
        var De;
        if (w !== null ? (te(w, "value"), De = "" + w) : (V !== null && (kt || (kt = !0, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), De = xr(D)), N(d))
    ...
    function zo(e, r, i) {
      vt("textarea", r), r.value !== void 0 && r.defaultValue !== void 0 && !Ht && (f("Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://reactjs.org/link/controlled-components"), Ht = !0), e.push(Ft("textarea"));
...
` && e.push(dn), u !== null && (te(u, "value"), e.push(jr("" + u))), null;
    ...
    function Jn(e, r, i, u) {
      ...
      return e.push(B), ie(e, D, d), typeof d == "string" ? (e.push(jr(d)), null) : d;
    }
    function Tr(e, r, i, u) {
      e.push(Ft(i));
      var d = null, D = null;
...
` && e.push(dn), d;
    ...
    function zn(e, r, i, u, d) {
      var D;
      return D = E(e, En), j(e, xn), i && (j(e, Po), j(e, ze(i)), j(e, Mn)), u && (j(e, gn), j(e, ze(u)), j(e, Mn)), d && (j(e, _n), j(e, ze(d)), j(e, Mn)), D = E(e, $n), D;
    }
    function OA(e, r) {
      return E(e, Cn);
    }
    ...
    var wa = Ce + ';$RX("', Ta = '$RX("', Sa = '"', ma = ")<\/script>", Uo = ",";
...
` + O[re].replace(" at new ", " at ");
                    return e.displayName && De.includes("<anonymous>") && (De = De.replace("<anonymous>", e.displayName)), typeof e == "function" && qA.set(e, De), De;
                  }
                while (re >= 1 && ae >= 0);
              break;
            }
    ...
    function to(e) {
      var r = Or, i = e;
      r !== i && (r === null ? fA(i) : i === null ? ii(r) : r.depth === i.depth ? cA(r, i) : r.depth > i.depth ? Fi(r, i) : Wi(r, i), Or = i);
    }
    function dA(e, r) {
      var i;
    ...
    function Ba(e, r, i) {
      ...
      var O = new e(r, u);
      {
        ...
        if (typeof e.getDerivedStateFromProps == "function" || typeof O.getSnapshotBeforeUpdate == "function") {
          var re = null, ae = null, De = null;
          if (typeof O.componentWillMount == "function" && O.componentWillMount.__suppressDeprecationWarning !== !0 ? re = "componentWillMount" : typeof O.UNSAFE_componentWillMount == "function" && (re = "UNSAFE_componentWillMount"), typeof O.componentWillReceiveProps == "function" && O.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? ae = "componentWillReceiveProps" : typeof O.UNSAFE_componentWillReceiveProps == "function" && (ae = "UNSAFE_componentWillReceiveProps"), typeof O.componentWillUpdate == "function" && O.componentWillUpdate.__suppressDeprecationWarning !== !0 ? De = "componentWillUpdate" : typeof O.UNSAFE_componentWillUpdate == "function" && (De = "UNSAFE_componentWillUpdate"), re !== null || ae !== null || De !== null) {
...
Please update the following components: %s`,
      ...
      typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount(), i !== r.state && (f("%s.componentWillMount(): Assigning directly to this.state is deprecated (except inside a component's constructor). Use setState instead.", ct(e) || "Component"), Zi.enqueueReplaceState(r, r.state, null));
    }
    function Ra(e, r, i, u) {
    ...
    function si(e, r, i) {
      ...
      if (V > 30) {
        var re = D - D % 5, ae = (1 << re) - 1, De = (w & ae).toString(32), nt = w >> re, Ot = D - re, Dr = fo(r) + Ot, ha = O << Ot, ya = ha | nt, pa = De + d;
        return {
          id: 1 << Dr | ya,
          overflow: pa
        };
    ...
    var Mo = typeof Object.is == "function" ? Object.is : li, Ue = null, vn = null, Dn = null, Ve = null, yr = !1, Ln = !1, go = 0, bt = null, Wr = 0, Nn = 25, Qr = !1, jn;
    function Vr() {
      if (Ue === null)
...
Incoming: %s`, jn, "[" + e.join(", ") + "]", "[" + r.join(", ") + "]");
    ...
    function ho() {
      return Ve === null ? Dn === null ? (yr = !1, Dn = Ve = Ji()) : (yr = !0, Ve = Dn) : Ve.next === null ? (yr = !1, Ve = Ve.next = Ji()) : (yr = !0, Ve = Ve.next), Ve;
    }
    function ci(e, r) {
      Ue = r, vn = e, Qr = !1, go = 0;
    }
    ...
    function hA() {
      Qr = !1, Ue = null, vn = null, Ln = !1, Dn = null, Wr = 0, bt = null, Ve = null;
    }
    function Xa(e) {
      return Qr && f("Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function components, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo()."), Fn(e);
    }
    function qi(e) {
    ...
    function _i(e, r, i) {
      if (e !== yo && (jn = "useReducer"), Ue = Vr(), Ve = ho(), yr) {
        ...
        var ae = Ve.queue = {
          last: null,
          dispatch: null
        }, De = ae.dispatch = _a.bind(null, Ue, ae);
        return [Ve.memoizedState, De];
      }
    }
    function $i(e, r) {
      Ue = Vr(), Ve = ho();
      ...
      Qr = !0;
      var D = e();
      return Qr = !1, Ve.memoizedState = [D, i], D;
    }
    function Ka(e) {
      Ue = Vr(), Ve = ho();
...
` + u.stack;
    ...
    var rn = S.ReactCurrentDispatcher, Do = S.ReactDebugCurrentFrame, Lo = 0, In = 1, ra = 2, Mi = 3, wn = 4, nu = 0, na = 1, Pr = 2, Au = 12800;
    function ou(e) {
    ...
    function gi(e, r, i, u, d, D, w, O, V) {
      ...
      nt.parentFlushed = !0;
      var Ot = DA(De, e, null, nt, ae, tn, oi, co);
      return re.push(Ot), De;
    }
    function No(e, r) {
      var i = e.pingedTasks;
      i.push(r), i.length === 1 && Y(function() {
        return Ma(e);
      });
    }
    function Gr(e, r) {
    ...
    function Aa(e, r, i) {
      pr(r, "Suspense");
      var u = r.blockedBoundary, d = r.blockedSegment, D = i.fallback, w = i.children, O = /* @__PURE__ */ new Set(), V = Gr(e, O), re = d.chunks.length, ae = nn(
        e,
        re,
        V,
        d.formatContext,
      ...
      De.parentFlushed = !0, r.blockedBoundary = V, r.blockedSegment = De;
      try {
        if (Io(e, r, w), zi(De.chunks, e.responseState, De.lastPushedText, De.textEmbedded), De.status = In, IA(V, De), V.pendingTasks === 0) {
          vr(r);
          return;
        }
      } catch (Ot) {
        De.status = wn, V.forceClientRender = !0, V.errorDigest = LA(e, Ot), pi(V, Ot);
      } finally {
        r.blockedBoundary = u, r.blockedSegment = d;
      }
      var nt = DA(e, D, u, ae, O, r.legacyContext, r.context, r.treeContext);
      nt.componentStack = r.componentStack, e.pingedTasks.push(nt), vr(r);
    }
    function oa(e, r, i, u) {
      pr(r, i);
      var d = r.blockedSegment, D = kr(d.chunks, i, u, e.responseState, d.formatContext);
      d.lastPushedText = !1;
      var w = d.formatContext;
      d.formatContext = Xr(w, i, u), Io(e, r, D), d.formatContext = w, er(d.chunks, i), d.lastPushedText = !1, vr(r);
    }
    function iu(e) {
    ...
    function NA(e, r, i, u, d) {
      ...
      i.props !== d && (ji || f("It looks like %s is reassigning its own `this.props` while rendering. This is not supported and can lead to confusing bugs.", ct(u) || "a component"), ji = !0);
      {
        ...
        if (w != null) {
          ...
          r.legacyContext = V, or(e, r, D), r.legacyContext = O;
          return;
        }
      }
      or(e, r, D);
    ...
    function au(e, r, i, u) {
      ...
      if (
        ...
        var ae = r.treeContext, De = 1, nt = 0;
        r.treeContext = si(ae, De, nt);
        try {
          or(e, r, w);
        } finally {
          r.treeContext = ae;
    ...
    function cu(e, r, i, u) {
      ...
      O = r.context, r.context = dA(d, D), or(e, r, w), r.context = ai(d), O !== r.context && f("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    ...
    function Ti(e, r, i, u, d) {
      ...
      switch (i) {
        ...
        case Wo: {
          pr(r, "SuspenseList"), or(e, r, u.children), vr(r);
          return;
        }
        case ka:
    ...
    function mi(e, r, i) {
      return C(r, e.responseState, i.formatContext, i.id), SA(e, r, i), H(r, i.formatContext);
    }
    function So(e, r, i) {
    ...
    function c(e, r, i, u) {
      ...
      var ae = gi(e, xa(i, r ? r.identifierPrefix : void 0), Yo(), 1 / 0, a, void 0, re, void 0, void 0);
...
function Ss() {
  return Ou || (Ou = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var Le = Object.prototype.hasOwnProperty, Ne = 0, Qe = 1, ke = 2, Ge = 3, pe = 4, Pe = 5, Ke = 6, At = ":A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", jt = At + "\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", ot = new RegExp("^[" + At + "][" + jt + "]*$"), yt = {}, ve = {};
    function me(t) {
      return Le.call(ve, t) ? !0 : Le.call(yt, t) ? !1 : ot.test(t) ? (ve[t] = !0, !0) : (yt[t] = !0, f("Invalid attribute name: `%s`", t), !1);
    }
    function It(t, n, a, c) {
      if (a !== null && a.type === Ne)
        return !1;
    ...
    function Ze(t, n, a, c, y, L, T) {
      this.acceptsBooleans = n === ke || n === Ge || n === pe, this.attributeName = c, this.attributeNamespace = y, this.mustUseProperty = a, this.propertyName = t, this.type = n, this.sanitizeURL = L, this.removeEmptyString = T;
    }
    var Oe = {}, Bt = [
      "children",
      "dangerouslySetInnerHTML",
    ...
    var Xt = {
      ...
      "aria-rowspan": 0,
      "aria-setsize": 0
    }, gt = {}, Ct = new RegExp("^(aria)-[" + jt + "]*$"), Rt = new RegExp("^(aria)[A-Z][" + jt + "]*$");
    function Sr(t, n) {
      {
    ...
    };
    {
      ...
      xt = function(t, n, a, c) {
        ...
        return typeof a == "boolean" && It(n, a, e, !1) ? (a ? f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.', a, n, n, a, n) : f('Received `%s` for a non-boolean attribute `%s`.\n\nIf you want to write it to the DOM, pass a string instead: %s="%s" or %s={value.toString()}.\n\nIf you used to conditionally omit it with %s={condition && value}, pass %s={condition ? value : undefined} instead.', a, n, n, a, n, n, n), $e[n] = !0, !0) : r ? !0 : It(n, a, e, !1) ? ($e[n] = !0, !1) : ((a === "false" || a === "true") && e !== null && e.type === Ge && (f("Received the string `%s` for the boolean attribute `%s`. %s Did you mean %s={%s}?", a, n, a === "false" ? "The browser will interpret it as a truthy value." : 'Although this works, it will not work as expected if you pass the string "false".', n, a), $e[n] = !0), !0);
      };
    }
    ...
    {
      var Yt = /^(?:webkit|moz|o)[A-Z]/, cr = /^-ms-/, Nr = /-(.)/g, ft = /;\s*$/, K = {}, Ae = {}, _ = !1, de = !1, Ie = function(t) {
      ...
      lr = function(t, n) {
        t.indexOf("-") > -1 ? Se(t) : Yt.test(t) ? we(t) : ft.test(n) && Fe(t, n), typeof n == "number" && (isNaN(n) ? Xe(t, n) : isFinite(n) || ze(t, n));
      };
    }
    var mt = lr, Nt = /["'&<>]/;
    function qt(t) {
    ...
    var be = b("<script>"), xe = b("<\/script>"), je = b('<script src="'), ut = b('<script type="module" src="'), Re = b('" async=""><\/script>');
    function Ye(t) {
    ...
    function fr(t, n, a, c, y) {
      var L = t === void 0 ? "" : t, T = n === void 0 ? be : b('<script nonce="' + at(n) + '">'), Q = [];
      if (a !== void 0 && Q.push(T, W(Ye(a)), xe), c !== void 0)
        for (var e = 0; e < c.length; e++)
          Q.push(je, W(at(c[e])), Re);
      if (y !== void 0)
        for (var r = 0; r < y.length; r++)
          Q.push(ut, W(at(y[r])), Re);
      return {
        bootstrapChunks: Q,
        startInlineScript: T,
    ...
    var st = 0, lt = 1, dr = 2, _t = 3, Tt = 4, Xr = 5, Mr = 6, gr = 7;
    function Pt(t, n) {
      return {
        insertionMode: t,
        selectedValue: n
      ...
      for (var y in a)
        if (Le.call(a, y)) {
          ...
          if (!(L == null || typeof L == "boolean" || L === "")) {
            ...
            e ? (T = W(at(y)), oe(L, y), Q = W(at(("" + L).trim()))) : (mt(y, L), T = s(y), typeof L == "number" ? L !== 0 && !Le.call(vt, y) ? Q = W(L + "px") : Q = W("" + L) : (oe(L, y), Q = W(at(("" + L).trim())))), c ? (c = !1, t.push(g, T, p, Q)) : t.push(z, T, p, Q);
          }
        }
      c || t.push(ie);
    }
        ...
        if (y !== null) {
          ...
          switch (y.type) {
            case Ge:
              ...
              return;
            case pe:
              c === !0 ? t.push(B, T, ge) : c === !1 || t.push(B, T, X, W(at(c)), ie);
              return;
            case Pe:
              isNaN(c) || t.push(B, T, X, W(at(c)), ie);
              break;
            case Ke:
              !isNaN(c) && c >= 1 && t.push(B, T, X, W(at(c)), ie);
              break;
            default:
              y.sanitizeURL && (ye(c, L), c = "" + c, q(c)), t.push(B, T, X, W(at(c)), ie);
          }
        } else if (me(a)) {
          switch (typeof c) {
            case "function":
    ...
    var kt = !1, Ir = !1, $t = !1, _r = !1, xr = !1, Yr = !1, wr = !1;
    function fn(t, n) {
      {
        var a = t[n];
        if (a != null) {
    ...
    function bo(t, n, a, c) {
      ...
      if (y != null) {
        var u;
        if (T !== null ? (ye(T, "value"), u = "" + T) : (e !== null && (Yr || (Yr = !0, f("Pass a `value` prop if you set dangerouslyInnerHTML so React knows which value should be selected."))), u = ko(L)), Ee(y))
    ...
    function Tr(t, n, a) {
      ...
      return typeof c == "string" && c[0] === `
` && t.push(Hr), c !== null && (ye(c, "value"), t.push(W(Cr("" + c)))), null;
    }
    function dn(t, n, a, c) {
      t.push(er(a));
      for (var y in n)
        ...
        if (Le.call(n, T)) {
          ...
          switch (T) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              me(T) && typeof Q != "function" && typeof Q != "symbol" && t.push(B, W(T), X, W(at(Q)), ie);
              break;
          }
        }
...
` && t.push(Hr), y;
    ...
    function qn(t, n, a, c, y) {
      switch (ht(n, a), ir(n, a), mr(n, a, null), !a.suppressContentEditableWarning && a.contentEditable && a.children != null && f("A component is `contentEditable` and contains `children` managed by React. It is now your responsibility to guarantee that none of those nodes are unexpectedly modified or duplicated. This is probably not intentional."), y.insertionMode !== dr && y.insertionMode !== _t && n.indexOf("-") === -1 && typeof a.is != "string" && n.toLowerCase() !== n && f("<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.", n), n) {
        ...
        default:
          return n.indexOf("-") === -1 && typeof a.is != "string" ? zr(t, a, n, c) : Ft(t, a, n, c);
      }
    }
    var zA = b("</"), kA = b(">");
    function bA(t, n, a) {
    ...
    var BA = b('<div hidden id="'), On = b('">'), UA = b("</div>"), RA = b('<svg aria-hidden="true" style="display:none" id="'), Qn = b('">'), Pn = b("</svg>"), YA = b('<math aria-hidden="true" style="display:none" id="'), HA = b('">'), FA = b("</math>"), tA = b('<table hidden id="'), WA = b('">'), o = b("</table>"), l = b('<table hidden><tbody id="'), M = b('">'), v = b("</tbody></table>"), k = b('<table hidden><tr id="'), C = b('">'), H = b("</tr></table>"), J = b('<table hidden><colgroup id="'), he = b('">'), Ce = b("</colgroup></table>");
    function Te(t, n, a, c) {
      switch (a.insertionMode) {
        ...
        case dr:
          return P(t, RA), P(t, n.segmentPrefix), P(t, W(c.toString(16))), $(t, Qn);
        case _t:
          return P(t, YA), P(t, n.segmentPrefix), P(t, W(c.toString(16))), $(t, HA);
        case Tt:
    ...
    var wa = b(tr + ';$RC("'), Ta = b('$RC("'), Sa = b('","'), ma = b('")<\/script>');
    function Uo(t, n, a, c) {
    ...
    var Ea = b(rr + ';$RX("'), Ca = b('$RX("'), Ro = b('"'), xa = b(")<\/script>"), Yo = b(",");
    function xi(t, n, a, c, y, L) {
      if (P(t, n.startInlineScript), n.sentClientRenderFunction ? P(t, Ca) : (n.sentClientRenderFunction = !0, P(t, Ea)), a === null)
        throw new Error("An ID must have been assigned before we can complete the boundary.");
      return P(t, a), P(t, Ro), (c || y || L) && (P(t, Yo), P(t, W(Ho(c || "")))), (y || L) && (P(t, Yo), P(t, W(Ho(y || "")))), L && (P(t, Yo), P(t, W(Ho(L)))), $(t, xa);
    }
    var zi = /[<\u2028\u2029]/g;
    function Ho(t) {
    ...
    function Bi() {
      {
        if (iA === 0) {
          Go = console.log, ct = console.info, Rn = console.warn, Zo = console.error, Xo = console.group, Jo = console.groupCollapsed, Ko = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: qo,
      ...
      var Q = new t(n, c);
      {
        ...
        if (typeof t.getDerivedStateFromProps == "function" || typeof Q.getSnapshotBeforeUpdate == "function") {
          ...
          if (typeof Q.componentWillMount == "function" && Q.componentWillMount.__suppressDeprecationWarning !== !0 ? r = "componentWillMount" : typeof Q.UNSAFE_componentWillMount == "function" && (r = "UNSAFE_componentWillMount"), typeof Q.componentWillReceiveProps == "function" && Q.componentWillReceiveProps.__suppressDeprecationWarning !== !0 ? i = "componentWillReceiveProps" : typeof Q.UNSAFE_componentWillReceiveProps == "function" && (i = "UNSAFE_componentWillReceiveProps"), typeof Q.componentWillUpdate == "function" && Q.componentWillUpdate.__suppressDeprecationWarning !== !0 ? u = "componentWillUpdate" : typeof Q.UNSAFE_componentWillUpdate == "function" && (u = "UNSAFE_componentWillUpdate"), r !== null || i !== null || u !== null) {
            var d = dt(t) || "Component", D = typeof t.getDerivedStateFromProps == "function" ? "getDerivedStateFromProps()" : "getSnapshotBeforeUpdate()";
    ...
    function Zi(t, n, a) {
      {
        ...
        var T = t.state;
        T && (typeof T != "object" || Ee(T)) && f("%s.state: must be set to an object or null", c), typeof t.getChildContext == "function" && typeof n.childContextTypes != "object" && f("%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().", c);
      }
    }
    function Pa(t, n) {
      var a = n.state;
...
Please update the following components: %s`,
    ...
    function lo(t, n, a) {
      ...
      if (e > 30) {
        var r = L - L % 5, i = (1 << r) - 1, u = (T & i).toString(32), d = T >> r, D = L - r, w = co(n) + D, O = Q << D, V = O | d, re = u + y;
        return {
          id: 1 << w | V,
          overflow: re
        };
      } else {
        var ae = Q << L, De = ae | T, nt = y;
        return {
          id: 1 << e | De,
          overflow: nt
        };
    ...
    var Va = typeof Object.is == "function" ? Object.is : Wa, Fr = null, li = null, Mo = null, Ue = null, vn = !1, Dn = !1, Ve = 0, yr = null, Ln = 0, go = 25, bt = !1, Wr;
    function Nn() {
      if (Fr === null)
        throw new Error(`Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:
1. You might have mismatching versions of React and the renderer (such as React DOM)
...
3. You might have more than one copy of React in the same app
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`);
      return bt && f("Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://reactjs.org/link/rules-of-hooks"), Fr;
    }
    function Qr(t, n) {
      if (n === null)
...
Incoming: %s`, Wr, "[" + t.join(", ") + "]", "[" + n.join(", ") + "]");
    ...
    function Vr() {
      return Ue === null ? Mo === null ? (vn = !1, Mo = Ue = jn()) : (vn = !0, Ue = Mo) : Ue.next === null ? (vn = !1, Ue = Ue.next = jn()) : (vn = !0, Ue = Ue.next), Ue;
    }
    function Ga(t, n) {
      Fr = n, li = t, bt = !1, Ve = 0;
    }
    function Ji(t, n, a, c) {
      for (; Dn; )
        Dn = !1, Ve = 0, Ln += 1, Ue = null, a = t(n, c);
      return ci(), a;
    }
    function ho() {
      var t = Ve !== 0;
    ...
    function ci() {
      bt = !1, Fr = null, li = null, Dn = !1, Mo = null, Ln = 0, yr = null, Ue = null;
    }
    function Za(t) {
    ...
    function qi(t, n, a) {
      if (t !== hA && (Wr = "useReducer"), Fr = Nn(), Ue = Vr(), vn) {
        var c = Ue.queue, y = c.dispatch;
        if (yr !== null) {
          var L = yr.get(c);
          if (L !== void 0) {
            yr.delete(c);
            var T = Ue.memoizedState, Q = L;
            do {
              var e = Q.action;
              bt = !0, T = t(T, e), bt = !1, Q = Q.next;
            } while (Q !== null);
            return Ue.memoizedState = T, [T, y];
          }
        }
...
` + c.stack;
    ...
    function ou(t, n) {
      var a = t.pingedTasks;
      a.push(n), a.length === 1 && Y(function() {
        return IA(t);
      });
    }
    function vA(t, n) {
    ...
    function LA(t, n, a, c) {
      ...
      y.formatContext = Er(T, a, c), Si(t, n, L), y.formatContext = T, bA(y.chunks, a), y.lastPushedText = !1, pr(n);
    }
    function jo(t) {
    ...
    function su(t, n, a, c) {
      ...
      Q = n.context, n.context = Fi(y, L), Ar(t, n, T), n.context = Wi(y), Q !== n.context && f("Popping the context provider did not return back to the original snapshot. This is a bug in React.");
    }
    ...
    function TA(t, n, a) {
      return Te(n, t.responseState, a.formatContext, a.id), To(t, n, a), qe(n, a.formatContext);
    }
    function SA(t, n, a) {
...
const Qu = async (I) => {
  ...
  if (Wu = !0, h != null)
    try {
      ...
      const R = JSON.parse(h).map((Y) => {
        if (Y.type === "object") {
          const U = Gu(Y.content, I);
          return { ...Y, content: U };
        }
        return Y;
      });
      setTimeout(() => {
        ...
        }), x(((Y = I.chatInput) == null ? void 0 : Y.disabled) || !1);
      }, 500);
    } catch {
  ...
  return Array.from(x.body.childNodes).map((Y, U) => {
    var j;
    if (Y.nodeType === Node.TEXT_NODE)
      return Y.textContent;
    {
      const E = Y.tagName.toLowerCase();
      let G = Array.from(Y.attributes).reduce((ce, ee) => {
  ...
  return I.contains("rcb-options") && (h.style = {
    ...
    borderColor: ((R = S.botOptionStyle) == null ? void 0 : R.color) || ((Y = S.theme) == null ? void 0 : Y.primaryColor),
  ...
  return I.contains("rcb-checkbox-row-container") && (h.style = {
    ...
    borderColor: ((R = S.botCheckboxRowStyle) == null ? void 0 : R.color) || ((Y = S.theme) == null ? void 0 : Y.primaryColor),
    cursor: `url(${(U = S.theme) == null ? void 0 : U.actionDisabledIcon}), auto`,
  ...
  return I.contains("rcb-checkbox-next-button") && (h.style = {
    ...
    borderColor: ((R = S.botCheckboxNextStyle) == null ? void 0 : R.color) || ((Y = S.theme) == null ? void 0 : Y.primaryColor),
    cursor: `url(${(U = S.theme) == null ? void 0 : U.actionDisabledIcon}), auto`,
  ...
  for (const U in S)
    if (window.speechSynthesis.getVoices().find((j) => {
      if (j.name === U) {
        R.voice = j, window.speechSynthesis.speak(R), Y = !0;
        return;
      }
    }), Y)
      break;
  Y || window.speechSynthesis.speak(R);
}, Bs = (I, h, S) => {
  var x, f, R, Y, U, j;
  (x = I.audio) != null && x.disabled || S.sender === "user" || typeof S.content != "string" || !(I != null && I.isOpen) && !((f = I.theme) != null && f.embedded) || !h || Ps(
    ...
    (Y = I.audio) == null ? void 0 : Y.voiceNames,
...
const Us = ({
  ...
  var Jt, sr, Kt, mr, lr, Yt, cr, Nr, ft;
  const { botOptions: h, setBotOptions: S } = Zt(), { messages: x, setMessages: f } = Yu(), { paths: R, setPaths: Y } = Na(), U = Zr(null), j = Zr(null), E = Zr(""), G = Zr(!1), P = Zr(!1), $ = Zr(null), ce = Zr(), ee = Zr(null), [ne, W] = He(!1), [b, te] = He(!0), [Me, fe] = He(!1), [ue, ye] = He(!0), [oe, We] = He(!1), [Le, Ne] = He(!1), [Qe, ke] = He(!1), [Ge, pe] = He(!1), [Pe, Ke] = He(!1), [At, jt] = He(0), [ot, yt] = He(!1), [ve, me] = He(), [It, pt] = He(0), [Ze, Oe] = He(((Jt = window.visualViewport) == null ? void 0 : Jt.height) || window.innerHeight), [Bt, Et] = He(((sr = window.visualViewport) == null ? void 0 : sr.width) || window.innerWidth), Mt = Zr(0);
  Gt(() => {
    var K, Ae, _, de, Ie, Se, we;
    if (window.addEventListener("click", Dt), window.addEventListener("keydown", Dt), window.addEventListener("touchstart", Dt), vt(), Ne((K = h.chatInput) == null ? void 0 : K.disabled), fe((Ae = h.audio) == null ? void 0 : Ae.defaultToggledOn), We((_ = h.voice) == null ? void 0 : _.defaultToggledOn), (de = h.chatHistory) != null && de.disabled)
      localStorage.removeItem((Ie = h.chatHistory) == null ? void 0 : Ie.storageKey);
    else {
      const Fe = localStorage.getItem((Se = h.chatHistory) == null ? void 0 : Se.storageKey);
      Fe != null && (f([{
        content: /* @__PURE__ */ F.jsx(ds, { chatHistory: Fe, showChatHistory: Sr }),
        sender: "system"
      }]), (we = h.chatHistory) != null && we.autoLoad && Pu(h, Fe, f, Ne));
    }
    return () => {
      window.removeEventListener("click", Dt), window.removeEventListener("keydown", Dt), window.removeEventListener("touchstart", Dt);
    };
  }, []), Gt(() => {
    xs(h);
  }, [(Kt = h.chatHistory) == null ? void 0 : Kt.storageKey, (mr = h.chatHistory) == null ? void 0 : mr.maxEntries, (lr = h.chatHistory) == null ? void 0 : lr.disabled]), Gt(() => {
    var K;
    Ur || (K = h.theme) != null && K.embedded || navigator.virtualKeyboard && (navigator.virtualKeyboard.overlaysContent = !0, navigator.virtualKeyboard.addEventListener("geometrychange", (Ae) => {
      if (!Ae.target)
        return;
      const { x: _, y: de, width: Ie, height: Se } = Ae.target.boundingRect;
      _ == 0 && de == 0 && Ie == 0 && Se == 0 ? (setTimeout(() => {
        var we;
        Oe((we = window.visualViewport) == null ? void 0 : we.height);
      }, 101), setTimeout(() => {
        var we, Fe;
        Ze != ((we = window.visualViewport) == null ? void 0 : we.height) && Oe((Fe = window.visualViewport) == null ? void 0 : Fe.height);
      }, 1001)) : setTimeout(() => {
        var we;
        Oe(((we = window.visualViewport) == null ? void 0 : we.height) - Se);
      }, 101);
    }));
  }, []), Gt(() => {
    Qu(x), Ut();
    ...
    var Ie, Se, we, Fe;
    if (h.isOpen && (pt(0), Oe((Ie = window.visualViewport) == null ? void 0 : Ie.height), Et((Se = window.visualViewport) == null ? void 0 : Se.width)), Ur)
      return;
    ...
    return h.isOpen ? (de(), document.body.style.position = "fixed", window.addEventListener("scroll", K), (we = window.visualViewport) == null || we.addEventListener("resize", _)) : (document.body.style.position = "static", de(), window.scrollTo({ top: Mt.current, left: 0, behavior: "auto" }), window.addEventListener("scroll", Ae), (Fe = window.visualViewport) == null || Fe.removeEventListener("resize", _)), de;
  }, [h.isOpen]), Gt(() => {
    const K = Lt();
    if (!K)
      return;
  ...
  const St = async (K, Ae, _) => {
    K === "start" && Ne(!0), await js(
      ...
      me,
      xt
    ), yt(!1), wt(), yu(P.current && !Ae.chatDisabled, h), G.current = !1;
  }, vt = async () => {
    var de, Ie, Se;
    ...
    Ae.gain.value = ((Se = h.notification) == null ? void 0 : Se.volume) || 0.2, ee.current = Ae;
    let _;
    if (K != null && K.startsWith("data:audio")) {
      const we = atob(K.split(",")[1]), Fe = new ArrayBuffer(we.length), Xe = new Uint8Array(Fe);
  ...
  }, Lt = () => R.length > 0 ? R[R.length - 1] : null, Xt = () => R.length > 1 ? R[R.length - 2] : null, gt = async (K, Ae = "bot") => {
    var Se, we, Fe, Xe, ze, mt;
    const _ = { content: K, sender: Ae };
    Bs(h, Me, _);
    const de = typeof _.content == "string" && _.sender === "bot" && ((Se = h == null ? void 0 : h.botBubble) == null ? void 0 : Se.simStream), Ie = typeof _.content == "string" && _.sender === "user" && ((we = h == null ? void 0 : h.userBubble) == null ? void 0 : we.simStream);
    if (de) {
      const Nt = (Fe = h.botBubble) == null ? void 0 : Fe.streamSpeed, qt = (Xe = h.botBubble) == null ? void 0 : Xe.dangerouslySetInnerHtml;
      await Ct(_, Nt, qt);
    } else if (Ie) {
    ...
    yt(!1), f((Fe) => [...Fe, K]), G.current = !0;
    let de = K.content;
    _ && (de = is(de));
    let Ie = 0;
    const Se = de.length;
    K.content = "", await new Promise((Fe) => {
    ...
    const _ = { content: K, sender: Ae };
    if (!G.current) {
      yt(!1), f((de) => [...de, _]), G.current = !0;
      return;
    }
    f((de) => {
      const Ie = [...de];
      for (let Se = Ie.length - 1; Se >= 0; Se--)
        if (Ie[Se].sender === Ae && typeof Ie[Se].content == typeof K) {
          Ie[Se] = _;
          break;
        }
      return Ie;
    ...
    Ne(_), _ || setTimeout(() => {
      var Ie, Se, we;
      (Ie = h.theme) != null && Ie.embedded ? xu(U.current) && ((Se = j.current) == null || Se.focus()) : K !== "start" && ((we = j.current) == null || we.focus());
    ...
    var de, Ie;
    clearTimeout(ve), Ae = Ae.trim(), E.current = Ae, Ae !== "" && (_ && await $e(Ae), U.current && (U.current.scrollTop = U.current.scrollHeight), j.current && (j.current.value = ""), (de = h.chatInput) != null && de.blockSpam && Ne(!0), P.current = oe, yu(!1, h), setTimeout(() => {
      yt(!0);
    }, 400), setTimeout(async () => {
      const Se = { prevPath: Xt(), userInput: Ae, injectMessage: gt, streamMessage: Rt, openChat: _e, openDrawer: it };
      await Fu(I, K, Se, Y) || (wt(), yu(P.current, h), yt(!1));
    ...
    if (_) {
      if (_.isSensitive) {
        ...
        if ((Ie = h == null ? void 0 : h.sensitiveInput) != null && Ie.maskInUserBubble) {
          await gt("*".repeat(((Se = h.sensitiveInput) == null ? void 0 : Se.asterisksCount) || 10), "user");
          return;
        }
      }
      await gt(K, "user");
  ...
  return /* @__PURE__ */ F.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ F.jsx(fs, {}),
        /* @__PURE__ */ F.jsx(cs, { unreadCount: It }),
        ...
        h.isOpen && !Ur && !((Yt = h.theme) != null && Yt.embedded) && /* @__PURE__ */ F.jsxs(F.Fragment, { children: [
        ...
        /* @__PURE__ */ F.jsxs(
          "div",
          {
            ...
            children: [
              ((cr = h.theme) == null ? void 0 : cr.showHeader) && /* @__PURE__ */ F.jsx(
                $u,
                {
              ...
              ((Nr = h.theme) == null ? void 0 : Nr.showInputRow) && /* @__PURE__ */ F.jsx(
                as,
                {
              ...
              ((ft = h.theme) == null ? void 0 : ft.showFooter) && /* @__PURE__ */ F.jsx(
                ls,
                {
                  inputRef: j,
                  flow: I,
...
const il = "data:image/svg+xml;base64,", al = "data:audio/wav;base64,", Su = {
  ...
  var ee;
  const [S, x] = He(ul(h)), [f, R] = He([]), [Y, U] = He(["start"]), j = I ?? os, E = (ne) => /* @__PURE__ */ F.jsx(Uu.Provider, { value: { botOptions: S, setBotOptions: x }, children: ne }), G = (ne) => /* @__PURE__ */ F.jsx(Hu.Provider, { value: { paths: Y, setPaths: U }, children: ne }), P = (ne) => /* @__PURE__ */ F.jsx(Ru.Provider, { value: { messages: f, setMessages: R }, children: ne }), $ = () => {
    var W, b, te;
    let ne = /* @__PURE__ */ F.jsx(Rs, { flow: j });
    return (W = S.advance) != null && W.useCustomMessages || (ne = P(ne)), (b = S.advance) != null && b.useCustomPaths || (ne = G(ne)), (te = S.advance) != null && te.useCustomBotOptions || (ne = E(ne)), ne;
  }, ce = () => {
    var ne, W;
    return Ur && ((ne = S.theme) == null ? void 0 : ne.desktopEnabled) || !Ur && ((W = S.theme) == null ? void 0 : W.mobileEnabled);
  };
  return /* @__PURE__ */ F.jsx(F.Fragment, { children: ce() && /* @__PURE__ */ F.jsx("div", { style: { fontFamily: (ee = S.theme) == null ? void 0 : ee.fontFamily }, children: $() }) });
};
export {
